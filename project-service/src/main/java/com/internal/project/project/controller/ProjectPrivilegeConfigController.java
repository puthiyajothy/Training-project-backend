...
import com.internal.project.projectdtomapper.ProjectPrivilegeConfigMapper;
...
public class ProjectPrivilegeConfigController {
	...
	public List<ProjectPrivilegeConfigDto> getProjectPrivilegeConfig() {
		try {
			logger.info(
					"Project Privilege Configuration Controller INFO -> Get All Project Privilege Configuration Method Started");
			return projectPrivilegeConfigMapper.getAllProjectPrivilegeConfiguration();
		} catch (Exception ex) {
			logger.error(
					"Project Privilege Configuration Controller INFO -> Get All Project Privilege Configuration Method Failed!");
			logger.error("Project Privilege Configuration Controller ERROR! :-> " + ex.getMessage());
		} finally {
			logger.info(
					"Project Privilege Configuration Controller INFO -> Get All Project Privilege Configuration Method Finished");
		}
		return null;
	}
	...
	public Object getProjectPrivilegeConfigById(@PathVariable(name = "severityId") Long projectConfigId) {
		try {
			logger.info(
					"Project Privilege Configuration Controller INFO -> Get Project Privilege Configuration By Id Method Started");
			// check severity id

			if (projectPrivilegeConfigMapper.getProjectPrivilegeConfigById(projectConfigId) != null) {
				logger.info(
						"Project Privilege Configuration Controller INFO -> Project Privilege Configuration Id Found -> Project Config Id : "
								+ projectConfigId);
				return projectPrivilegeConfigMapper.getProjectPrivilegeConfigById(projectConfigId);
			} else {
				logger.warn(
						"Project Privilege Configuration Controller WARNING! -> Project Privilege Configuration Id Not Found -> Project Config Id : "
								+ projectConfigId);
	...
	public ResponseEntity<String> saveSeverity(
			@Valid @RequestBody ProjectPrivilegeConfigDto projectPrivilegeConfigDto) {
		try {
			logger.info(
					"Project Privilege Configuration Controller INFO -> Save Project Privilege Configuration Method Started");
			if (projectPrivilegeConfigMapper.saveProjectPrivilegeConfig(projectPrivilegeConfigDto) != null) {
				logger.info(
						"Project Privilege Configuration Controller -> Project Privilege Configuration Created Successful");
				return new ResponseEntity<>("Project Privilege Configuration added succesfully", HttpStatus.OK);
			}
			logger.info(
					"Project Privilege Configuration Controller INFO -> Project Privilege Configuration Creation FAILED!!!");
			return new ResponseEntity<>("SAVE FAILED!", HttpStatus.BAD_REQUEST);
		} catch (Exception ex) {
			logger.error("Project Privilege Configuration Controller ERROR! :-> " + ex.getMessage());
		} finally {
			logger.info(
					"Project Privilege Configuration Controller INFO -> Save Project Privilege Configuration Method Finished");
		}
		return null;
	}
	...
	public ResponseEntity<String> updateSeverity(@RequestBody ProjectPrivilegeConfigDto projectPrivilegeConfigDto) {
		logger.info(
				"Project Privilege Configuration Controller -> Update Project Privilege Configuration Method Started");
		try {
			...
			logger.info(
					"Project Privilege Configuration Controller -> Project Privilege Configuration Updated Failed!!!");
			return new ResponseEntity<>("Update FAILED!!!", HttpStatus.BAD_REQUEST);
		} finally {
			logger.info(
					"Project Privilege Configuration Controller -> Update Project Privilege Configuration Method Finished");
		}
	}
	...
	public ResponseEntity<String> deleteSeverity(@PathVariable(name = "projectConfigId") Long projectConfigId) {
		logger.info(
				"Project Privilege Configuration Controller -> Delete Project Privilege Configuration Method Started");
		try {
			// check severity id
			if (projectPrivilegeConfigMapper.getProjectPrivilegeConfigById(projectConfigId) != null) {
				...
				if (projectPrivilegeConfigMapper.deleteProjectPrivilegeConfigById(projectConfigId) == null) {
					logger.info(
							"Project Privilege Configuration Controller -> Project Privilege Configuration Deleted Successful");
					return new ResponseEntity<>("Project Privilege Configuration Sucessfully deleted", HttpStatus.OK);
				} else {
					logger.info(
							"Project Privilege Configuration Controller -> Delete Project Privilege Configuration Failed, Project Privilege Configuration Id Not Found -> Severity Id :"
									+ projectConfigId);
					return new ResponseEntity<>(
							"No Project Privilege Configuration Found For This Id : " + projectConfigId,
							HttpStatus.BAD_REQUEST);
				}
			}
		} finally {
			logger.info(
					"Project Privilege Configuration Controller -> Delete Project Privilege Configuration Method Finished");
		}
		return null;
	}
